...
class BaseProjectService extends BaseService {
	...
	async initSetup() {
		...
		let F = (c) => 'bx_' + c;
		const INSTALL_CL = 'setup_marathon';
		const COLLECTIONS = ['setup', 'admin', 'log', 'news', 'activity', 'activity_join', 'fav', 'user', 'pay'];
		const CONST_PIC = '/images/cover.gif';


		const NEWS_CATE = '1=公告';
		const ACTIVITY_CATE = '1=线上马拉松,2=全程马拉松,3=半程马拉松,4=Mini马拉松,5=其他';
